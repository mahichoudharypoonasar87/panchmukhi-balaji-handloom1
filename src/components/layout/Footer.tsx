          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {FEATURES.map(({ icon: Icon, title, desc }) => (
              ...
              >
                ...
                <div>
                  <p className="text-ivory-100 font-semibold text-sm font-body">
                    {title}
                  </p>
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-2">
              <div className="flex items-start gap-2">
                ...
                <span className="text-[#A08060] text-xs font-body">
              ...
              <div className="flex items-center gap-2">
                ...
                <a
                  href="mailto:panchmukhibalajihandloom@gmail.com"
                  className="text-[#A08060] text-xs font-utility hover:text-gold-500 transition-colors"
                >
                  panchmukhibalajihandloom@gmail.com
                </a>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-2">
            <p className="text-[#A08060] text-xs font-utility text-center sm:text-left">
              © {new Date().getFullYear()} Panchmukhi Balaji Handloom, Poonasar, Rajasthan.
              All rights reserved.
            </p>
